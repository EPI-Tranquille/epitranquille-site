    ...
    >
      <Container>
        ...
        <div className="custom-typography">
          ...
          <p>
            Chez EPI Tranquille nous sommes soucieux des droits des individus,
            notamment au regard des traitements automatisés et dans une volonté
            de transparence avec ses clients, nous avons mis en place une
          ...
          <p>
            La présente politique d’utilisation des données personnelles est
            faite conformément aux dispositions de la Loi n°78-17 du 6 janvier
            1978 (dite « Loi informatique et libertés » ou « LIL ») et du
          ...
          <p>
            La politique de confidentialité s’applique à l’ensemble des services
            fournis par EPI Tranquille à savoir :
          </p>
          <ul>
            <li>
          ...
          <p>ci-après les “Services”.</p>
          <p></p>
          <p>
            Sauf mention explicite contraire, les sections ci-dessous
            s’appliquent au Site et à l’Application.
          </p>
          <h2>Identité de l’organisme responsable du traitement des données</h2>
          <p>
            La société Samuel Girardin, domiciliée 11 rue fondère 13004
            Marseille et immatriculée au RNE sous le numéro 822551941
            représentée par Samuel Girardin, ci-après, “Le Responsable”.
          </p>
          <p></p>
          <p>
            En cas de questions sur l’utilisation de vos données personnelles
            sur notre Site ou notre Application, vous pouvez nous contacter par
            e-mail à l’adresse :{' '}
            <a
              target="_blank"
              rel="noopener noreferrer nofollow"
          ...
          <p>
            ...
            des différents services (Site et Application) que ces derniers aient
            créé un compte sur l’Application ou non. Elles sont désignées
            ci-après les “Utilisateurs”.
          </p>
          <h2>Collecte et protection des données</h2>
          <p>
          ...
          <p>
            Le Responsable assure aux Utilisateurs une collecte et un traitement
            des données personnelles dans le respect de la vie privée
            conformément à la loi n°78-17 du 6 janvier 1978 relative à
            l'informatique, aux fichiers aux libertés et dans le respect de la
            règlementation applicable en matière de traitement des données à
            caractère personnel conformément au règlement (UE) 2016/679 du
            Parlement européen et du Conseil du 27 avril 2016 (ci-après,
            ensemble, la "Règlementation applicable en matière de protection des
            Données à caractère personnel").
          </p>
          <p>
            Les informations personnelles pouvant être recueillies sur le Site
            ou l’Application sont utilisées pour le fonctionnement ou
            l’amélioration des services, ou pour des besoins de promotions ou de
            communication avec les Utilisateurs uniquement.
          </p>
          <h3>Site</h3>
          <p>
          ...
          <ul>
            <li>
              adresse e-mail (lors de l’inscription à la newsletter OU la
              communication sur le lancement)
            </li>
          </ul>
          <h3>Application</h3>
          <p>
            Les données personnelles collectées via l’Application (version web
            ou mobile) sont les suivantes :
          </p>
          ...
          <ul>
            ...
            <li>
              statut d'utilisateur (particulier, pro, association, collectivité,
              structure privée) ;
            </li>
            <li>adhésion active au SNAPEC, SNPSC ou à la FFCAM ;</li>
            <li>
              données financières : dans le cadre du paiement des abonnements
              payants proposés sur l’Application.
            </li>
          </ul>
          <h2>Finalités des données collectées par le Site</h2>
          <p>
            Les données personnelles collectées auprès des Utilisateurs ont pour
            objectif la mise à disposition des services du Site, leur
          ...
          <ul>
            ...
            <li>mise en oeuvre d'une assistance pour les Utilisateurs ;</li>
            <li>
              prévention et détection des fraudes, malwares (logiciels
              malveillants) et gestion des incidents de sécurité ;
            </li>
            <li>
              envoi de newsletter d’information pour les Utilisateurs qui se
              sont inscrits à la newsletter ;
            </li>
            <li>analyse statistique.</li>
          </ul>
          <h2>Finalités des données collectées par l’Application</h2>
          <p>
            Les données personnelles collectées auprès des Utilisateurs ont pour
            objectif la mise à disposition des services de l’Application, leur
            amélioration et le maintien d'un environnement sécurisé. La base
            légale des traitements est&nbsp; l’exécution du contrat entre
            l’utilisateur et l’Application. Plus précisément, les utilisations
            sont les suivantes :
          </p>
          <ul>
            <li>
            ...
            <li>mise en œuvre d'une assistance pour les Utilisateurs ;</li>
            <li>
              vérification, identification et authentification des données
              transmises par les Utilisateurs ;
            </li>
            <li>
              activation d’un abonnement pour un utilisateur adhérent d’un
            ...
            <li>
              envoi d'informations sur les nouvelles fonctionnalités de
              l’Application en fonction des préférences des Utilisateurs ;
            </li>
            <li>
              envoi de mails de notifications pour la gestion des parcs EPI des
              Utilisateurs de l’Application en fonction de leur préférences ;
            </li>
            <li>
            ...
            <li>analyse statistique ;</li>
            <li>
              gestion d’une liste d’opposition au traitement de données
              personnelles.
            </li>
          </ul>
          <h2>Politique de conservation des données</h2>
          <p>
            L’Application et le Site conservent vos données pour la durée
            nécessaire pour vous fournir ses services ou son assistance.
          </p>
          <p>
            Dans un objectif de transparence complète nous avons essayé de
            fournir ici les durées de conservation des données selon leur
            finalité :
          </p>
          <table>
            <thead>
              <tr>
                <th>Finalités des données pour le Site</th>
                <th>Durée de conservation des données</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>gestion du fonctionnement et optimisation du Site</td>
                <td></td>
              </tr>
              <tr>
                <td>mise en oeuvre d'une assistance pour les Utilisateurs</td>
                <td></td>
              </tr>
              <tr>
                <td>
          ...
          <table>
            <thead>
              <tr>
                <th>Finalités des données pour l’Application</th>
                <th>Durée de conservation des données</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <td>mise en œuvre d'une assistance pour les Utilisateurs</td>
                <td></td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>gestion des éventuels litiges avec les Utilisateurs</td>
                <td></td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>
                  envoi de mails de notifications pour la gestion des parcs EPI
                  des Utilisateurs de l’Application en fonction de leur
                  préférences
                </td>
                <td></td>
              </tr>
          ...
          <p>
            Les données personnelles utilisées dans l’Application peuvent être
            partagées avec des sociétés tierces, dans les cas suivants :
          </p>
          <ul>
            <li>
              quand l'utilisateur utilise les services de paiement pour la
              souscription d’un abonnement à l’Application, pour la mise en
              oeuvre de ces services, la Plateforme est en relation avec des
              sociétés bancaires et financières tierces avec lesquelles elle a
              passé des contrats. Ces sociétés tierces sont les suivantes :
              Apple pour les abonnements mobile souscrits via l’Apple Store,
              Google pour les abonnements mobile souscrits via le Play Store et
              Stripe pour les abonnements mobile souscrits via l’application
              web. Citons également RevenueCat qui est utilisé dans les trois
              cas précédents ;
            </li>
            <li>
              quand l’Application recourt aux services de prestataires pour
              fournir l'assistance utilisateurs, les services de paiement et les
              envois de mail. Ces prestataires disposent d'un accès limité aux
              données de l'utilisateur, dans le cadre de l'exécution de ces
              prestations, et ont l'obligation contractuelle de les utiliser en
              conformité avec les dispositions de la réglementation applicable
              en matière protection des données à caractère personnel ;
            </li>
            <li>
              quand l'utilisateur invite un membre sur son parc EPI, les données
              du parc sont partagées ainsi que le nom, le prénom et l’adresse
              e-mail de l’utilisateur ;
            </li>
            <li>
              si la loi l'exige, le Responsable peut effectuer la transmission
          ...
          <p>
            Le Responsable met en oeuvre des mesures organisationnelles,
            ...
            sécurisé et que les Services ne peuvent pas garantir à 100% la
          ...
          <p>
            ...
            <Link href="/politique-cookies">ici</Link>.
          </p>
          <h2>
          ...
          <ul>
            <li>
              ...
              la mise en œuvre de ce droit, le Responsable peut demander une
            ...
            <li>
              ...
              demander au Responsable de limiter le traitement des données
          ...
          <p>
            Le Responsable se réserve le droit d'apporter toute modification à
            la présente politique de confidentialité à tout moment. Si une
            modification est apportée à la présente, le Responsable s'engage à
            publier la nouvelle version sur son Site. Le Responsable informera
            également les utilisateurs de la modification par messagerie
            électronique, dans un délai minimum de 15 jours avant la date
            d'effet.
          </p>
          <p></p>
          <p>
            Si l'utilisateur n'est pas d'accord avec les termes de la nouvelle
            politique de confidentialité, il a la possibilité de supprimer son
            compte.
          </p>
          <p>
