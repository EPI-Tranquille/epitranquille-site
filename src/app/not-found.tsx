  ...
  return (
    <Layout>
      <Container className="relative isolate flex h-full flex-col items-center justify-center py-20 text-center sm:py-32">
        <CirclesBackground className="absolute left-1/2 top-1/2 -z-10 mt-44 w-272.5 -translate-x-1/2 -translate-y-1/2 stroke-gray-300/30 mask-[linear-gradient(to_bottom,white_20%,transparent_75%)]" />
        ...
        <p className="mt-2 text-lg text-gray-600">
          Désolé nous n'avons pas trouvé cette page. Elle a peut-être été
